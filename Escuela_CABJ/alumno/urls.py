...
from alumno.views import listado_alumnos, index, crear_alumno, actualizar_alumno, borrar_alumno, detalle_alumno
...
urlpatterns = [
    ...
    path("detalle_alumno/<int:pk>", detalle_alumno, name="detalle_alumno"),
